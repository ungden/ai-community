      ...
      <div className="hidden lg:flex flex-1 bg-[#1877f2] items-center justify-center p-12">
        <div className="max-w-md">
          <h2 className="text-4xl font-bold text-white mb-6">
            Bắt đầu hành trình học AI
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Đăng ký để truy cập bài viết, khóa học và case study về AI.
          </p>
          <ul className="space-y-4">
            <li className="flex items-center gap-4 text-white">
              ...
              <span className="text-lg">Nội dung cập nhật hàng ngày</span>
            </li>
            <li className="flex items-center gap-4 text-white">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <span className="text-lg">👥</span>
              </div>
              <span className="text-lg">Cộng đồng chất lượng, không spam</span>
            </li>
            <li className="flex items-center gap-4 text-white">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <span className="text-lg">💬</span>
              </div>
              <span className="text-lg">Hỗ trợ trực tiếp từ người sáng lập</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="mt-8 text-sm text-gray-500">
            Đã có tài khoản?{' '}
            <Link href="/auth/login" className="text-[#1877f2] hover:underline font-medium">
              Đăng nhập
            </Link>
          </p>
